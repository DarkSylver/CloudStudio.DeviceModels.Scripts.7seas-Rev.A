...
# Parsing + Configuration Script – 7seas - Rev. A

This **Parsing + Configuration** script is designed for the **7seas** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – 7seas Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **7seas** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
